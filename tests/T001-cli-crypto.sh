...
test-expect "$(ls_key_format "$(ls_privkey_path)")" "private:pkcs8:valid=rsa" "Private key recognized"
test-expect "$(ls_key_format "$(ls_pubkey_path)")" "public:spki:" "Public key recognized"
